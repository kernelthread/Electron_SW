...
; Modifications to work with ACME assembler by Dennis May 2021
; Original available from https://github.com/pfusik/zlib6502

; Assemble with acme (https://github.com/meonwax/acme), for example:
; acme -o inflate.bin -r inflate.lst -l inflate.sym -Dinflate=$5800 -Dinflate_CodeLengthTable=$900 -Dinflate_SymbolTable=$A40 -Dinflate_HuffmanTrees=$C00 -Dinflate_zp=$70 inflate.asm
; 
; inflate is 508 bytes of code and constants
; inflate_zp is 10 bytes on page zero
; inflate_CodeLengthTable is 318 bytes of uninitialized data
; inflate_SymbolTable is 318 bytes of uninitialized data
; inflate_HuffmanTrees is 129 bytes of uninitialized data
...
; CodeLengthTable 318 bytes
	* =	inflate_CodeLengthTable
literalSymbolCodeLength
	* =	*+256
controlSymbolCodeLength
	* =	*+CONTROL_SYMBOLS

; SymbolTable 318 bytes
	* =	inflate_SymbolTable
codeToLiteralSymbol
	* =	*+256
codeToControlSymbol
